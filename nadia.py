...
def banner():
    print("\n%s ___________________________    \n%s/__  ___/__/ ____/  _   /  /   ║ %sAUTHOR %sYOSHI%s-%sTECH\n%s  / /  __// /  _/  /_/  / /    ║ %sFACEBOOK %s: %sYOSHI\n%s / /  /__/ /__/ /  _   / /____ ║ %sTeam     %s: %sFX TEAM TECH\n%s/_/______/_____/__//__/______/ ║ %sGithub   %s: %sZuck-Ker\n"%(O,O,P,O,P,O,O,P,O,P,O,P,O,P,O,P,O,P))
def menu_log():
